...
exports.createNewDatabase = void 0;
var createNewDatabase = function (dbName, ver, objectStores) { return __awaiter(void 0, void 0, void 0, function () {
    var request_1;
    return __generator(this, function (_a) {
        //check database and store. if not exist, create one. 
        try {
            if (window.indexedDB) {
                request_1 = indexedDB.open(dbName, ver);
                ...
                request_1.onupgradeneeded = function (event) {
                    ...
                    try {
                        for (var objectStores_1 = __values(objectStores), objectStores_1_1 = objectStores_1.next(); !objectStores_1_1.done; objectStores_1_1 = objectStores_1.next()) {
                            var objectStore = objectStores_1_1.value;
                        ...
                        try {
                            if (objectStores_1_1 && !objectStores_1_1.done && (_a = objectStores_1.return)) _a.call(objectStores_1);
                        }
