...
exports.getAllItemIDB = exports.getItemIDB = void 0;
var getItemIDB = function (dbName, ver, storeName, key) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return [2 /*return*/, new Promise(function (res, rej) {
                    if (window.indexedDB) {
                        ...
                        request_1.onsuccess = function (event) {
                            ...
                            var idbRequest = objectStore.get(key);
                            idbRequest.onsuccess = function (evt) {
                                var _a;
                                res(((_a = evt === null || evt === void 0 ? void 0 : evt.target) === null || _a === void 0 ? void 0 : _a.result) || {});
                            };
                        };
...
exports.getItemIDB = getItemIDB;
var getAllItemIDB = function (dbName, ver, storeName) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            return [2 /*return*/, new Promise(function (res, rej) {
                    if (window.indexedDB) {
                        //let results:any = []
                        var request_2 = indexedDB.open(dbName, ver);
                        ...
                        request_2.onblocked = function (event) {
                            console.log('getItemIDB onblocked');
                        };
...
exports.getAllItemIDB = getAllItemIDB;
